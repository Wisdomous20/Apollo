...
import { Sparkles, Shield, Brain, Stethoscope } from 'lucide-react';
          ...
          <div className="relative lg:grid lg:grid-cols-12 lg:gap-12 lg:items-center">
            ...
            <div className="absolute inset-0 p-4 sm:p-6 flex flex-col justify-end lg:relative lg:col-span-7 lg:p-0 lg:flex lg:items-center lg:justify-start">
              <div className="w-full space-y-4 sm:space-y-6 lg:space-y-8">
                <div>
                  <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white lg:text-slate-900 font-serif leading-[1.1] mb-3 sm:mb-4 lg:mb-6 drop-shadow-lg lg:drop-shadow-none">
        ...
        >
          <div className="relative lg:grid lg:grid-cols-12 lg:gap-12 lg:items-center">
            ...
            <div className="absolute inset-0 p-4 sm:p-6 flex flex-col justify-end lg:relative lg:col-span-7 lg:p-0 lg:flex lg:items-center lg:justify-start lg:order-1">
              <div className="w-full space-y-4 sm:space-y-6 lg:space-y-8">
                <div>
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-white lg:text-slate-900 font-serif leading-[1.1] mb-3 sm:mb-4 lg:mb-6 drop-shadow-lg lg:drop-shadow-none">
                    Our Mission
                  </h2>
                  <p className="text-sm sm:text-base lg:text-xl text-slate-50 lg:text-slate-600 leading-relaxed font-serif mb-3 sm:mb-4 lg:mb-8 drop-shadow-md lg:drop-shadow-none">
