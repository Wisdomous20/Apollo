...
export default function Payment() {
  return (
    <section className="py-16 bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 relative overflow-hidden">
      {/* Background Pattern: Greek Key (Meander) and Circles */}
      <div className="absolute inset-0 pointer-events-none select-none z-0">
        {/* Subtle Greek key pattern top */}
        <svg
          className="absolute top-0 left-0 w-full h-16 lg:h-24 opacity-20"
          viewBox="0 0 1440 96"
          fill="none"
        ...
        <svg
          className="absolute bottom-0 left-0 w-full h-16 lg:h-24 opacity-20"
          viewBox="0 0 1440 96"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          preserveAspectRatio="none"
        ...
        <div className="absolute top-10 right-10 w-32 h-32 border border-white rounded-full opacity-10"></div>
        <div className="absolute bottom-10 left-10 w-24 h-24 border border-white rounded-full opacity-10"></div>
      </div>
            ...
            <div className="flex flex-col items-end max-w-lg w-full">
              <div className="w-full space-y-8">
                ...
                <motion.p
                  ...
                  viewport={{ once: true }}
                  className="text-xl text-white/90 leading-relaxed font-serif"
                >
